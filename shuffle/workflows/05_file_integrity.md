# Shuffle Workflow — File Integrity Monitoring

## Purpose
Automate alert-to-case handling and response actions for **File Integrity Monitoring**, including enrichment and SOC notifications.
...
## References
- ATT&CK techniques: T1070, T1547
- Workflow export (sanitized): `../exports/file-integrity.json`
- Analyst playbook (SOP): `../../soc-process/playbooks/file-integrity.md`
