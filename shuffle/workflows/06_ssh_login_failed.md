# Shuffle Workflow — SSH Login Failed (Brute Force)

## Purpose
Automate alert-to-case handling and response actions for **SSH Login Failed (Brute Force)**, including enrichment and SOC notifications.
...
## References
- ATT&CK techniques: T1110
- Workflow export (sanitized): `../exports/ssh-login-failed.json`
- Analyst playbook (SOP): `../../soc-process/playbooks/ssh-bruteforce.md`
